...
export const TRANSLATION_CLAUSE_SPLIT_TARGET_CHARS = 160;
export const TRANSLATION_CLAUSE_SPLIT_MIN_CHARS = 56;
export const TRANSLATION_CLAUSE_SPLIT_MAX_LOOKAHEAD_CHARS = 240;
