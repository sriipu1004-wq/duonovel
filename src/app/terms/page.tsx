    ...
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-10 sm:px-6">
        ...
        <Section title="第2条 サービス内容">
          <p>
            本サービスは、小説等の文章作品の投稿、公開、閲覧、検索、朗読音声の登録・再生、個人本棚、対訳、AI物語生成、
            そのほか関連機能を提供するサービスです。
          </p>
          <p>
        ...
        <Section title="第14条 有料サブスクリプション">
          <p>
            有料サブスクリプションは月額680円（税込）で、申込日に初回決済を行い、利用者が解約するまで毎月同日に自動更新されます。申込前に料金、自動更新、利用上限および解約条件を表示し、明示的な同意を取得します。
          </p>
          <p>
            有料契約中は、AI物語生成を1日10回、公開作品の翻訳解放を1日30回まで利用でき、個人本棚への取り込みは日次回数制限なしです。個人本棚には最大20作品を保存できます。AIを新規に呼び出す操作には、公平利用とサービス継続のため月間AI利用上限も適用されます。解放済みの公開作品翻訳の再読、読書および読み上げは月間AI利用上限を消費しません。
          </p>
          <p>
