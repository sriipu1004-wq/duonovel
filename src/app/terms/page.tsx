    ...
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-10 sm:px-6">
        ...
        <Section title="第2条 サービス内容">
          <p>
            本サービスは、小説等の文章作品の投稿、公開、閲覧、検索、朗読音声の登録・再生、個人本棚、対訳、単語解説、AI物語生成、
            そのほか関連機能を提供するサービスです。
          </p>
          <p>
        ...
        <Section title="第14条 有料サブスクリプション">
          ...
          <p>
            有料契約中は、AI物語生成1日10回、対訳生成1日30回、単語解説の日次回数制限なし、次話1話の先読みを利用できます。AIを新規に呼び出す操作には、公平利用とサービス継続のため月間AI利用上限も適用されます。保存済み対訳・単語解説キャッシュの閲覧、読書および読み上げは月間AI利用上限を消費しません。
          </p>
          <p>
