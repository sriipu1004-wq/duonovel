    ...
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-10 sm:px-6">
        ...
        <Section title="第12条 有料サブスクリプション">
          ...
          <p>
            有料契約中は、公開作品の翻訳解放を1日30回まで利用でき、個人本棚への取り込みは日次回数制限なしです。個人本棚には最大20作品を保存できます。AI翻訳・単語解説などAIを新規に呼び出す操作には、公平利用とサービス継続のため月間AI利用上限も適用されます。解放済みの公開作品翻訳の再読、読書および読み上げは月間AI利用上限を消費しません。
          </p>
          <p>
