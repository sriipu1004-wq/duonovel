    ...
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-10 sm:px-6">
        ...
        <Section title="第2条 サービス内容">
          <p>
            本サービスは、小説等の文章作品の投稿、公開、閲覧、検索、朗読音声の登録・再生、個人本棚、対訳、
            そのほか関連機能を提供するサービスです。
          </p>
          <p>
        ...
        <Section title="第4条 投稿作品・朗読音声・その他コンテンツ">
          <p>
            利用者は、自らが投稿、登録、送信、公開する文章（人による翻訳を含みます）、音声、画像、説明文、タイトル、
          ...
          <p>
            作品の作者が「人による翻訳」を許可した場合、当該作者は、他の利用者が本サービス上でその作品を翻訳し、
            当該翻訳を本サービス上で公開・表示するために必要な範囲で、非独占的に利用することを許可するものとします。
            この設定は著作権の譲渡を意味せず、翻訳者が作成した翻訳に関する権利も、法令および原作品の権利関係に従います。
          </p>
        </Section>
        ...
        <Section title="第11条 個人本棚">
          <p>
            個人本棚は、利用者本人だけが閲覧する非公開機能です。利用者は、自ら作成した作品、著作権の保護期間が満了した作品、または複製・保存・翻訳等について適法な権限を持つ作品だけを取り込むものとします。
          </p>
          <p>
            個人本棚の内容は公開一覧、検索および共有の対象になりません。利用者は、技術的保護手段の回避、違法に入手したファイルの保存、または第三者への再配布のために本機能を利用してはなりません。
          </p>
          <p>
            対訳生成または単語解説を実行した場合、処理に必要な本文または選択した文脈がAI提供事業者へ送信されます。機密情報を含む文書を取り込まないでください。
          </p>
        </Section>

        <Section title="第12条 有料サブスクリプション">
          <p>
            有料サブスクリプションは月額680円（税込）で、申込日に初回決済を行い、利用者が解約するまで毎月同日に自動更新されます。申込前に料金、自動更新、利用上限および解約条件を表示し、明示的な同意を取得します。
          </p>
          <p>
            有料契約中は、公開作品のAI翻訳解放を1日30回まで利用でき、個人本棚への取り込みは日次回数制限なしです。個人本棚には最大20作品を保存できます。AI翻訳・単語解説などAIを新規に呼び出す操作には、公平利用とサービス継続のため月間AI利用上限も適用されます。解放済みの公開作品AI翻訳の再読、読書および読み上げは月間AI利用上限を消費しません。Human translationはAI翻訳とは別で、AI翻訳利用枠・クレジット・月間AI利用上限を消費しません。
          </p>
          <p>
            解約はサブスクページの契約管理から行えます。解約後も支払済み期間の終了までは有料機能を利用でき、利用者都合の日割り返金は行いません。ただし、法令上必要な場合または重複請求等が確認された場合を除きます。
          </p>
          <p>
            販売条件の詳細は
            <Link className="underline underline-offset-4" href="/commercial-transactions">
              特定商取引法に基づく表記
            </Link>
            を確認してください。
          </p>
