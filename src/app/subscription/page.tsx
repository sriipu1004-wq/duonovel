...
const pricingSeoCopy: Record<UiLocale, { title: string; description: string; summary: string; freeHeader: string; premiumHeader: string }> = {
  ja: {
    ...
    summary: "Freeは¥0。Premiumは月額680円（税込・JPY）です。Freeでは公開作品のAI翻訳解放と個人本棚への取り込みが合計1日3回の共通枠です。Premiumでは公開作品のAI翻訳解放は1日30回、個人本棚への取り込みは日次回数制限なしです。Human translationはAI利用枠やクレジットを消費しません。",
    freeHeader: "Free — ¥0",
    premiumHeader: "Premium — 月額680円",
  },
  en: {
    title: "Pricing: Free and Premium plans | LIB read",
    description: "LIB read pricing: Free is ¥0 and Premium is ¥680/month in JPY. Compare public AI-translation unlocks, My Library imports, read-aloud, and library storage limits.",
    summary: "Free costs ¥0. Premium costs ¥680 per month in JPY. On Free, public AI-translation unlocks and My Library imports share 3 uses per day. Premium provides up to 30 public AI-translation unlocks/day and no daily count limit for library imports. Human translation does not consume AI allowance or credits.",
    freeHeader: "Free — ¥0",
  ...
  ko: {
    ...
    summary: "Free는 ¥0, Premium은 월 ¥680(JPY)입니다. Free에서는 공개 작품 AI 번역 잠금 해제와 개인 서재 가져오기가 합산 하루 3회를 공유합니다. Premium은 공개 AI 번역 하루 30회, 개인 서재 가져오기 일일 횟수 제한 없음입니다. Human translation은 AI 이용량이나 크레딧을 소비하지 않습니다.",
    freeHeader: "Free — ¥0",
