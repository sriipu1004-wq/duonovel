  ...
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <Section title="3. 個人本棚へ長編を取り込む">
        ...
        <p>
          元ファイル自体はサーバーへ保存せず、ブラウザで抽出した本文を本人限定の領域へ保存します。個人本棚の作品は公開一覧、検索、共有ページには表示されません。
        </p>
        <p>
      ...
      <Section title="8. 生成回数とAI物語">
        ...
        <p>
          <Link className="underline underline-offset-4" href="/subscription">月額500円のサブスク</Link>
