...
export default function GuidePage() {
  return (
    <main className="min-h-screen bg-white text-black">
      ...
      <Section title="7. 試作段階について">
        <p>
          LIB read は試作・改善段階を含むサービスです。画面、機能、導線、仕様、表示内容は今後変わる可能性があります。
        </p>
        <p>
          そのため、ある時点では使えた機能が調整中になったり、表示位置や文言が変わることがあります。
          逆に、まだ未完成の部分が今後追加されることもあります。
        </p>
      </Section>
