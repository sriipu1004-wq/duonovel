    ...
    <main className="min-h-screen bg-white text-black">
      <div className="mx-auto w-full max-w-4xl px-4 py-10 sm:px-6">
        ...
        <dl className="mt-7 rounded-[28px] border border-black/10 bg-white px-5 shadow-sm sm:px-7">
          ...
          <Row label="クレジット利用条件">
            クレジットはLIB read内の対象となる公開話のAI翻訳解放にのみ利用でき、現金への換金、他ユーザーへの譲渡、作者報酬への転換はできません。1クレジットで1話・1対象言語のAI翻訳を解放し、同じ利用者による解放済みAI翻訳の再読では追加クレジットを消費しません。Human translationにはクレジットを使用せず、AI利用枠・月間AI利用上限も消費しません。
          </Row>
          <Row label="動作環境">
            JavaScript、CookieおよびWeb Storageを利用できる最新版のChrome、Safari、Edge等のブラウザ。読み上げ機能はブラウザと端末の音声合成機能に依存します。
          </Row>
          <Row label="利用上限">
            公開AI翻訳の新規解放にはプランに応じた日次上限があります。AI翻訳・単語解説などAIを新規に呼び出す操作には月間AI利用上限と不正利用防止策が適用されます。購入クレジットはこれらのAI処理原価上限を解除するものではありません。
          </Row>
        </dl>
      </div>
    </main>
