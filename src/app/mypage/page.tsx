...
export default async function MyPage() {
  ...
  const initialBio =
    typeof author?.bio === "string" && author.bio.trim()
      ? author.bio
      : typeof author?.profile === "string" && author.profile.trim()
        ? author.profile
        : typeof author?.description === "string" && author.description.trim()
          ? author.description
          : metadataBio;
  const initialXUrl =
    typeof author?.x_url === "string" && author.x_url.trim()
      ? author.x_url
      : typeof author?.xUrl === "string" && author.xUrl.trim()
        ? author.xUrl
        : "";
  const initialNoteUrl =
    typeof author?.note_url === "string" && author.note_url.trim()
      ? author.note_url
      : typeof author?.noteUrl === "string" && author.noteUrl.trim()
        ? author.noteUrl
        : "";
  ...
  const initialDisplayName = rawDisplayName.trim()
    ? rawDisplayName
