      ...
      <div className="mx-auto flex w-full max-w-4xl flex-col gap-6 px-4 py-10 sm:px-6">
        ...
        <Section title="一般的な問い合わせ">
          ...
          <ul className="list-disc space-y-2 pl-5">
            <li>サービスの不具合報告</li>
            <li>個人本棚のファイル取り込み、章分割、読書進捗に関する問い合わせ</li>
            <li>対訳、単語解説、生成回数表示に関する問い合わせ</li>
            <li>アカウント、サブスク判定、公開設定、表示に関する問い合わせ</li>
            <li>機能要望、改善提案</li>
            <li>その他運営への連絡</li>
          </ul>
          <p>
            不具合報告には、利用したファイル形式、作品名、話数、操作手順、表示されたエラー、端末とブラウザを記載してください。
          </p>
          <p>
            著作権で保護された小説や文書の本文全体をメールへ添付しないでください。必要な場合は、個人情報を隠した画面画像と短い該当箇所だけを送ってください。
          </p>
        </Section>
