...
export default async function RecordCreateSeriesPage({ params }: PageProps) {
  ...
  return (
    <main className="min-h-screen w-full max-w-[100vw] overflow-x-hidden bg-[#f4f4f4] text-black">
      <div className="mx-auto w-full max-w-[100vw] overflow-x-hidden px-3 py-5 sm:max-w-7xl sm:px-6 lg:px-8">
