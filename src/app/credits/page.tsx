...
const COPY = {
  ja: {
    ...
    rule4: "クレジットは買い切りです。5クレジット¥300、8クレジット¥450、12クレジット¥600で、いずれも購入日から150日有効です。現金化・譲渡はできません。",
  ...
  en: {
    ...
    rule4: "Credits are a one-time purchase: 5 credits for ¥300, 8 for ¥450, or 12 for ¥600. All purchased credits are valid for 150 days from the purchase date and cannot be cashed out or transferred.",
  ...
  ko: {
    ...
    rule4: "크레딧은 일회성 구매입니다. 5크레딧 ¥300, 8크레딧 ¥450, 12크레딧 ¥600이며 구매 크레딧은 모두 구매일로부터 150일 동안 유효합니다. 현금화·양도는 할 수 없습니다.",
