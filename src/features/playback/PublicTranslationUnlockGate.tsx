...
const COPY = {
  ja: {
    ...
    loginAction: "ログイン",
    included: "本日の利用枠を1回使って、この話の翻訳を解放できます。",
    ...
    includedUnlock: "本日の利用枠で翻訳を解放",
    includedConfirmTitle: "この話の翻訳を解放しますか？",
    includedConfirmBody: "本日の利用枠を1回使います。解放後は、この話の同じ翻訳言語を何度読み直しても追加消費されません。",
    includedGenerateConfirm: "翻訳が未生成のため、続行するとAI翻訳を生成します。",
    includedConfirm: "翻訳を解放",
    exhausted: "本日の利用枠を使い切りました。",
    creditOffer: "この話の翻訳は1クレジットで解放できます。",
    unlock: "1クレジットでこの話の翻訳を解放",
    balance: (value: number) => `クレジット: ${value}`,
    buy: "クレジットを購入",
    premium: "Premiumを確認",
    confirmTitle: "1クレジットでこの話の翻訳を解放しますか？",
  ...
  en: {
    ...
    loginAction: "Sign in",
    included: "Use 1 use from today's included daily allowance to unlock this episode's translation.",
    includedGenerate: "This translation is not ready yet. Unlocking will generate it with AI.",
    includedReady: "This translation is already prepared. Unlocking will not start a new AI generation.",
    includedUsage: (used: number, limit: number) => `Today's usage: ${used}/${limit}`,
    includedUnlock: "Unlock with today's allowance",
    includedConfirmTitle: "Unlock this episode's translation?",
    includedConfirmBody: "This uses 1 use from today's included daily allowance. After unlocking, you can reread this episode in the same translation language without another charge.",
    includedGenerateConfirm: "The translation is not generated yet, so continuing will start AI translation generation.",
    includedConfirm: "Unlock translation",
    exhausted: "You've used today's included daily allowance.",
    creditOffer: "Unlock this episode's translation for 1 credit.",
    unlock: "Unlock this episode's translation for 1 credit",
    balance: (value: number) => `Credits: ${value}`,
    buy: "Buy credits",
    premium: "View Premium",
    confirmTitle: "Unlock this episode's translation for 1 credit?",
  ...
  ko: {
    ...
    loginAction: "로그인",
    included: "오늘 포함된 일일 이용 한도에서 1회를 사용해 이 화의 번역을 잠금 해제할 수 있습니다.",
    ...
    includedUnlock: "오늘 이용 한도로 번역 잠금 해제",
    includedConfirmTitle: "이 화의 번역을 잠금 해제할까요?",
    includedConfirmBody: "오늘 포함된 일일 이용 한도에서 1회를 사용합니다. 잠금 해제 후에는 같은 번역 언어로 이 화를 다시 읽어도 추가 소모가 없습니다.",
    includedGenerateConfirm: "번역이 아직 생성되지 않아 계속하면 AI 번역 생성을 시작합니다.",
    includedConfirm: "번역 잠금 해제",
    exhausted: "오늘 포함된 일일 이용 한도를 모두 사용했습니다.",
    creditOffer: "이 화의 번역을 1크레딧으로 잠금 해제할 수 있습니다.",
    unlock: "1크레딧으로 이 화의 번역 잠금 해제",
    balance: (value: number) => `크레딧: ${value}`,
    buy: "크레딧 구매",
    premium: "Premium 보기",
    confirmTitle: "1크레딧으로 이 화의 번역을 잠금 해제할까요?",
