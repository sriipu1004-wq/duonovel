...
const en = {
  ...
  unlimitedUpgrade: "Unlimited with ¥680/month subscription",
  failedHelp:
  ...
  generationUpgrade: "Increase generation limits for ¥680/month",
